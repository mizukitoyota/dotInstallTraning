...
//var sales = ["taguchi": 200, "fkoji": 300] //型推論sales内に２つのデータをセット
//sales["fkoji"] = 500//fkojiのデータを上書き
//print(sales["taguchi"] ?? "n.a")//taguchiの中に値がなければ"n.a"あればログ
//sales["dotinstall"] = 400//３つ目のデータ
//print(sales.count)//３つデータをカウント
//print(sales.values)//データ内の値をログに出力
//for(key,value) in sales {
//    print("\(key): \(value)")//辞書内データ出力
//}
////let SS = [String: Int]()//からの辞書作成
////print(SS.isEmpty)//空の辞書かどうか確かめる
